...
public class PROPULSION : MonoBehaviour {
  ...
  //  --------------------------------------------
	...
	void Turn(){
		...
		Vector3 Pos = body.target.position  -transform.position;
    ...
    void Avoid_Wall(){
		...
		Debug.DrawRay(Center,transform.forward*5f,Color.cyan);
       ...
       // ---------------------------EVITEMENT HORIZONTAL POUR LA TOUR---------------------------//
        ...
        if (Physics.SphereCast(Center,5f,transform.forward,out hit,5f,mask))
